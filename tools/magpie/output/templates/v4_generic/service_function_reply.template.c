...
static inline void /*-?function.get_name()-*/_reply(CORBA_Object _client/*LOOP function.get_params_out()*/, /*-?LOOPITEM['typename']-*/ * /*-?LOOPITEM['name']-*//*ENDLOOP*/ /*-if function.get_return_type() != 'void'*/, /*-?function.get_return_type()-*/ __retval /*fi-*/)
{
	...
	_buf._out._msgtag = /*-?function.get_num_untyped_output_words()-*/ + (/*-?2 * function.get_fpages_count()-*/ << 6);
