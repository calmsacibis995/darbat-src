...
#ifdef L4IOKIT
#include <stdlib.h>
#define _USE_XOPEN	/* needed for strdup */
...
#else
        entry->symbols_malloc = 0/*vm_address_t*/;
#endif
    }
    free(entry);
    return;
...
*
*******************************************************************************/
#ifdef L4IOKIT	/* gcc insists on a function proto.  Oh well. */
