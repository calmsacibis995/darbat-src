...
#ifdef L4IOKIT
	    //IOLog("IOInterruptEventSource::%s autoDisable = %d\n", 
		//__FUNCTION__, autoDisable);
#endif
            if (autoDisable) {
...
{
#ifdef L4IOKIT
//IOLog("IOInterruptEventSource::%s in you baby!\n", __FUNCTION__);
//L4_KDB_Enter("XXX");
#endif
...
{
#ifdef L4IOKIT
//IOLog("IOInterruptEventSource::disableInterruptOccurred %p %d\n",
//	prov, source);
//L4_KDB_Enter("XXX");
#endif
IOTimeTypeStampS(IOINTES_INTCTXT);
