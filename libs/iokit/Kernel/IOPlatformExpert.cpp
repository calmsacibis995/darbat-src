...
{
#ifdef L4IOKIT
    //IOLog("IOPlatformExpert::attach\n");
#endif
    if( !super::attach( provider ))
	return( false);

#ifdef L4IOKIT
    //IOLog("IOPlatformExpert::attach returns true (phew)\n");
#endif
    return( true);
}
...
#ifdef L4IOKIT
  //IOLog("IOPlatformExpert:registerInterruptController: registering (%p)\n",
	//interruptController);
  //L4_KDB_Enter("kdebug");
#endif
