...
#ifdef L4IOKIT
	IOLog("kmod_lookupbyname_locked ret = %d (non-zero if loaded)\n", ret);
#endif
...
#ifdef L4IOKIT
#ifdef VERBOSE_IOKIT
	IOLog("calling kmod_load_function(), kr = %d\n", (int)kr);
#endif
#endif
...
#ifdef L4IOKIT
#ifdef VERBOSE_IOKIT
	IOLog("gIOCatalogModuleRequests request %s\n", moduleName);
#endif
#endif
...
#ifdef L4IOKIT
#ifdef VERBOSE_IOKIT
    IOLog("kmod_load_request name = %s returning %d\n", moduleName, ret);
#endif
#endif
