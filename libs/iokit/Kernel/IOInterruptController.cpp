...
#ifdef L4IOKIT
  //IOLog("IOInterruptController::registerInterrupt called with "
//	"nub %p source %d target %p handler %p refCon %p vector %p number %d\n",
	//nub, source , target, handler, refCon, vector, vectorNumber);
  //L4_KDB_Enter("blah");
#endif
...
#ifdef L4IOKIT
  //IOLog("IOSharedInterruptController::initInterruptController running\n");
  //L4_KDB_Enter("blah");
#endif
...
#ifdef L4IOKIT
  //IOLog("IOSharedInterruptController::initInterruptController finished super::init\n"); 
  //L4_KDB_Enter("blah");
#endif
...
#ifdef L4IOKIT
  //IOLog("IOSharedInterruptController::initInterruptController done IOMalloc\n");
  //L4_KDB_Enter("blah");
#endif 
  sourceIsLevel = false;
...
#ifdef L4IOKIT
  //IOLog("IOSharedInterruptController::initInterruptController returns success!\n");
  //L4_KDB_Enter("blah");
#endif 
  return kIOReturnSuccess;
}
...
#else
    return OSMemberFunctionCast(IOInterruptAction, this, &IOSharedInterruptController::handleInterrupt);
#endif
}
