...
void IOCPUInterruptController::setCPUInterruptProperties(IOService *service)
{
...
#ifdef L4IOKIT
  //IOLog("IOCPUInterruptController::setCPUInterruptProperties running\n");
  //L4_KDB_Enter("blah");
#endif 
  ...
  specifier->release();
#ifdef L4IOKIT
  //IOLog("IOCPUInterruptController::setCPUInterruptProperties done!\n");
  //L4_KDB_Enter("blah");
#endif 
}
...
#else
                               OSMemberFunctionCast(IOInterruptHandler, this, &IOCPUInterruptController::handleInterrupt), 0);
#endif
...
#ifdef L4IOKIT
   //IOLog("IOCPUInterruptController::registerInterrupt called with nub %p "
//	"source %d target %p "
  //      "handler %p refCon %p\n", nub, source, target, handler, refCon);
    //L4_KDB_Enter("blah");
#endif
...
#ifdef L4IOKIT
    //IOLog("IOCPUInterruptController::registerInterrupt asserting wait on %p\n",
//	this);
#endif
