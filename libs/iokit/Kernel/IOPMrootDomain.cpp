...
#ifdef L4IOKIT
    //IOLog("IOPMRootDomain::start\n");
#endif
    setProperty(kRootDomainSupportedFeatures, tmpDict);
    tmpDict->release();
   
#ifdef L4IOKIT
    //IOLog("IOPMRootDomain::start assigning workloop\n");
#endif 
    pm_vars->PMworkloop = IOWorkLoop::workLoop();				
#ifdef L4IOKIT
    //IOLog("IOPMRootDomain::start doing PMPowerStateQueue(%p)\n", this);
#endif
    pmPowerStateQueue = IOPMPowerStateQueue::PMPowerStateQueue(this);
#ifdef L4IOKIT
    //IOLog("IOPMRootDomain::start running addEventSource\n");
#endif
