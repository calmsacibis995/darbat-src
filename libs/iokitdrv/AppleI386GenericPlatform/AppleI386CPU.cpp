...
#ifdef L4IOKIT
    //IOLog("AppleI386CPU::start starting\n");
#endif
...
#ifdef L4IOKIT
#if 0
    IOLog("AppleI386CPUInterruptController::handleInterrupt: "
	"vector %p reg %d handler %p target %p nub %p src %d\n", 
	vector, vector->interruptRegistered, vector->handler, vector->target,
	vector->nub, source);
#endif
#endif
