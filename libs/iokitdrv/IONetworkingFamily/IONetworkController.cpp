...
#ifdef L4IOKIT
    IOLog("IONetworkController::start being run.\n");
#endif
...
#ifdef L4IOKIT
    IOLog("IONetworkController::start superclass.\n");
#endif
...
#ifdef L4IOKIT
    IOLog("IONetworkController::start returning true!!!.\n");
#endif
    return true;
}
...
#ifdef L4IOKIT
	IOLog("kCommandEnable succeeded client = %p\n", client);
	//L4_KDB_Enter("");
#endif
...
{
#ifdef L4IOKIT
	IOLog("executeCommand %p %p %p kCommandEnable %p\n",
	    client, &IONetworkController::handleCommand, this,
	    client);
	//L4_KDB_Enter("");
#endif
