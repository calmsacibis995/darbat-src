...
{
#ifdef L4IOKIT
    IOLog("IOEthernetInterface::init called\n");
    //L4_KDB_Enter("");
#endif
...
#ifdef L4IOKIT
    IOLog("IOEthernetInterface::init setting enet specific fields\n");
    //L4_KDB_Enter("");
#endif
...
#ifdef L4IOKIT
    IOLog("IOEthernetInterface::init returns true\n");
    //L4_KDB_Enter("");
#endif
#ifdef L4IOKIT
    // XXX
    // this implicitly brings up the interface.
   // I am not quite sure how I can bring up the interface, what is the
   // exactly method to do so hence this nasty hack.
    //SInt X = syncSIOCSIFADDR(controller);
    //IOLog("syncSIOCSIFADDR return %d\n", X);
    //L4_KDB_Enter("");
#endif
    ...
    switch ( cmd )
    {
        ...
        case SIOCSIFLLADDR:
            ret = (int) ctr->executeCommand(
                             this,            /* client */
#ifndef L4IOKIT
                             OSMemberFunctionCast(IONetworkController::Action,
				this,
...
#ifdef L4IOKIT
	IOLog("enableController returns %d\n", ret);
	//L4_KDB_Enter("");
#endif
    return ret;
}
...
IOEthernetInterface::setupMulticastFilter(IONetworkController * ctr)
{
	...
	ifnet_free_multicast_list(addressList);
#ifdef L4IOKIT
	IOLog("setupMulticastFilter ret = %d\n", ret);
	//L4_KDB_Enter("");
#endif
    return ret;
}
...
{
#ifdef L4IOKIT
    IOLog("IOEthernetInterface::attachToDataLinkLayer called\n");
    //L4_KDB_Enter("");
#endif
...
#ifdef L4IOKIT
    IOLog("IOEthernetInterface::attachToDataLinkLayer retruns true\n");
    //L4_KDB_Enter("");
#endif
    return ret;
}
