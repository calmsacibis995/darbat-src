...
// XXX L4IOKIT: doesn't work with generic GCC.
...
#else
} __attribute__((aligned(1))) cb_configure_t;
#endif
...
#else
} __attribute__((aligned(1))) cb_mcsetup_t;
#endif
...
#else
} __attribute__((aligned(1))) cb_iasetup_t;
#endif
...
#else
} __attribute__((aligned(1))) port_selftest_t;
#endif
...
#else
} __attribute__((aligned(1))) errorCounters_t;
#endif
...
#else
} __attribute__((aligned(1))) tcb_t;
#endif

// L4IOKIT This is not the RIGHT way to reset alignment!!  This doesn't
// undo pack!! XXX!!
//#pragma pack()	//unwid the pack stack
