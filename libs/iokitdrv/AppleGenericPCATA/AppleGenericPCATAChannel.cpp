                                     ...
                                     IORegistryEntry * dtEntry )
{
...
#ifdef L4IOKIT
		{
	     IOLog("AppleGenericPCATAChannel::init false1.\n");
#endif
             return false;
#ifdef L4IOKIT
		}
...
#ifdef L4IOKIT
		{
	     IOLog("AppleGenericPCATAChannel::init false2\n");
#endif
             return false;
#ifdef L4IOKIT
		}
...
#ifdef L4IOKIT
	IOLog("AppleGenericPCATAChannel::init fProvider false.\n");
#endif
    if (fProvider == 0)
        return false;
    ...
    {
#ifdef L4IOKIT
	IOLog("AppleGenericPCATAChannel::init can't reg dev interrupt (%d)\n",
		vector);
#endif
        return false;
    }
