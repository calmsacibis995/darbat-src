                        ...
                        IOService ** targetP, UInt32 index )
{
    ...
    static const IOExternalMethod methodTemplate[] = {
#ifdef L4IOKIT	/* sucks, c++ doesn't like void * */
/* 0 */  { NULL, (IOMethod)0, kIOUCScalarIScalarO, 1, 0 },
/* 1 */  { NULL, (IOMethod)0, kIOUCScalarIScalarO, 1, 0 },
/* 2 */  { NULL, (IOMethod)0, kIOUCScalarIScalarO, 1, 0 },
#else
