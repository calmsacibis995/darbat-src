...
IOATAController::asyncData(void)
{
	...
	{
#ifdef L4IOKIT
	//IOLog("IOATAController:%s nothing to do\n", __FUNCTION__);
	//L4_KDB_Enter("X");
#endif
...
#ifdef L4IOKIT
#if 0
		IOLog("IOATAController::%s got status 0x%lx\n", 
		    __FUNCTION__, status);
		//L4_KDB_Enter("X");
#endif
#endif
...
#ifdef L4IOKIT
#if 0
			IOLog("IOATAController::%s device err\n", 
			    __FUNCTION__);
			//L4_KDB_Enter("X");
#endif
#endif
...
#ifdef L4IOKIT
#if 0
			IOLog("IOATAController::%s txDataIn %p %d\n",
			    __FUNCTION__,
			    _doubleBuffer.logicalBuffer,
			    bufferBytes);
			//L4_KDB_Enter("X");
#endif
#endif
...
#ifdef L4IOKIT
#if 0
			IOLog("IOATAController::%s trying to write %d %p %d\n",
			    __FUNCTION__,
			    xfrPosition, 
			    _doubleBuffer.logicalBuffer, 
			    bufferBytes);
...
#ifdef L4IOKIT
#if 0
			IOLog("IOATAController::%s trying to read %d %p %d\n",
			    __FUNCTION__,
			    xfrPosition, 
			    _doubleBuffer.logicalBuffer, 
			    bufferBytes);
...
#ifdef L4IOKIT
#if 0
			IOLog("IOATAController::%s txDataOut %p %d\n",
			    __FUNCTION__,
			    _doubleBuffer.logicalBuffer,
			    bufferBytes);
			//L4_KDB_Enter("X");
...
#ifdef L4IOKIT
#if 0
	IOLog("IOATAController::%s returning with kATANoErr.\n",
	    __FUNCTION__);
	//L4_KDB_Enter("X");
#endif
#endif
...
#ifdef L4IOKIT
#if 0
	IOLog("IOATAController::scanForDrives found %d units\n", unitsFound);
#endif
#endif	
	return unitsFound;
