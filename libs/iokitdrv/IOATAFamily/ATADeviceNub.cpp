...
#ifdef L4IOKIT
	//IOLog("ATADeviceNub::ataDeviceNub running nub creat %p\n", nub);
	//L4_KDB_Enter("XXX");
#endif
	if( ! nub )
		return 0L;
...
#ifdef L4IOKIT
	//IOLog("ATADeviceNub::ataDeviceNub returning nub %p\n", nub);
	//L4_KDB_Enter("XXX");
#endif	
	return nub;
...
#ifdef L4IOKIT
	//IOLog("ATADeviceNub::getDeviceID buffer %p\n", buffer);
	////L4_KDB_Enter("XXX");
#endif
...
#ifdef L4IOKIT
//		IOLog("ATADeviceNub::getDeviceID failed with !desc\n");
		//L4_KDB_Enter("XXX");
#endif	
...
#ifdef L4IOKIT
	//	IOLog("ATADeviceNub::getDeviceID failed with !cmd\n");
		//L4_KDB_Enter("XXX");
#endif
 		string = OSString::withCString( "failed" );
	...
	{
#ifdef L4IOKIT
//		IOLog("ATADeviceNub::%s exepccted kATADeviceType OK.\n",
	//	    __FUNCTION__);
		//L4_KDB_Enter("XXX");
#endif
...
#ifdef L4IOKIT
	//IOLog("ATADeviceNub::getDeviceID returning with err %d\n", err);
	//L4_KDB_Enter("X");
#endif
	return err;
