...
#ifdef L4IOKIT
#if 0
		// let's make sure that we are getting a model string ..
		IOLog("IOATABlockStorageDriver::%s got fModel %s\n",
		    __FUNCTION__, fModel);
#endif
#endif
	}
...
#ifdef L4IOKIT
#if 0
	IOLog("IOATABlockStorageDriver::doGetFormatCapacities running\n");
	//L4_KDB_Enter("X");
#endif
#endif	
...
#ifdef L4IOKIT
#if 0
			IOLog("IOATABlockStorageDriver::%s hiLBA %lu "
			    "loLBA %lu\n", __FUNCTION__, hiLBA, loLBA);
			//L4_KDB_Enter("X");
#endif
#endif
...
#ifdef L4IOKIT
#if 0
			IOLog("IOATABlockStorageDriver::%s fUseLBAAddressing "
			    "fst %lu snd %lu\n",
			    __FUNCTION__,
			    fDeviceIdentifyData[kATAIdentifyLBACapacity + 1],
			    fDeviceIdentifyData[kATAIdentifyLBACapacity]);
			//L4_KDB_Enter("X");
#endif
#endif	
...
#ifdef L4IOKIT
#if 0
			IOLog("IOATABlockStorageDriver::%s ELSE case"
			    "fst %lu snd %lu thrd %lu\n",
			    __FUNCTION__,
			    fDeviceIdentifyData[kATAIdentifySectorsPerTrack],
...
#ifdef L4IOKIT
#if 0
	IOLog("IOATABlockStorageDriver::%s badness\n", __FUNCTION__);
	L4_KDB_Enter("X");
#endif
#endif
	return 0;
...
#ifdef L4IOKIT
#if 0
	IOLog("IOATABlockStorageDriver::reportMaxValidBlock %llu\n",
	    diskCapacity);	
#endif
#endif
