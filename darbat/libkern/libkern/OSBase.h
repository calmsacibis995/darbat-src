...
/* The way these are handled is really dodgey. We should need to have
 * this hack for *too* long, I hope. CEG.
 */

#define MK_ABS_PTR(x) ((void*)(x))
#define MK_ABS(x) (*((AbsoluteTime*)&(x)))
