...
{
	/* kernel thread state */
	struct i386_kernel_state kstate;

	/* used for user stuff - possibly remove? */
	...
	/* XXX: I think this needs removing... */
        unsigned int retvals[2];
        int continued_syscall_no;

	/* what action to do on blah */
	int trap_return_action;
