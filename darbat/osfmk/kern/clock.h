...
/* we need this for the lousy AbsoluteTime stuff */
...
#define clock_get_uptime(a)		\
	clock_get_uptime(__OSAbsoluteTimePtr(MK_ABS_PTR(a)))

#define clock_interval_to_deadline(a, b, c)		\
	clock_interval_to_deadline((a), (b), __OSAbsoluteTimePtr(MK_ABS_PTR(c)))

#define clock_interval_to_absolutetime_interval(a, b, c)	\
	clock_interval_to_absolutetime_interval((a), (b), __OSAbsoluteTimePtr(MK_ABS_PTR(c)))

#define clock_absolutetime_interval_to_deadline(a, b)	\
	clock_absolutetime_interval_to_deadline(__OSAbsoluteTime(MK_ABS(a)), __OSAbsoluteTimePtr(MK_ABS_PTR(b)))

#define clock_deadline_for_periodic_event(a, b, c)	\
	clock_deadline_for_periodic_event(__OSAbsoluteTime(MK_ABS(a)), __OSAbsoluteTime(MK_ABS(b)), __OSAbsoluteTimePtr(MK_ABS_PTR(c)))

#define clock_delay_until(a)	\
	clock_delay_until(__OSAbsoluteTime(MK_ABS(a)))

#define absolutetime_to_nanoseconds(a, b)	\
	absolutetime_to_nanoseconds(__OSAbsoluteTime(MK_ABS(a)), (b))

#define nanoseconds_to_absolutetime(a, b)	\
	nanoseconds_to_absolutetime((a), __OSAbsoluteTimePtr(MK_ABS_PTR(b)))
