...
#if 1  /* pre-multi-threaded kernel */
	load_context(thread);
#else
	/* FIXME: use the above when threads work :) */
...
kernel_bootstrap_thread(void)
{
     ...
     */
#if 0
	printf( "XXX: Skipping commpage_populate\n" );
#else
    commpage_populate();
#endif
...
#if 0  /* pre-multi-threaded kernel */
	printf( ">>>> Dropping into syscall loop\n" );
