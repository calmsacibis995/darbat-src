...
extern struct tws_hash * task_dynamic_working_set(task_t task);
extern integer_t task_pageins_inc(task_t task);
extern integer_t task_pageins_dec(task_t task);
extern integer_t task_cow_faults_inc(task_t task);
extern integer_t task_faults_inc(task_t task);
extern int task_priv_flags(task_t task);

// Darbat Extensions

void *task_get_next_utcb_base(task_t task);
eas_ref_t task_get_eas(task_t task);
void task_set_eas(task_t task, eas_ref_t eas);
