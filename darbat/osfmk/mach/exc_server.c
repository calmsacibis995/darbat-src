...
mig_internal kern_return_t __MIG_check__Request__exception_raise_t(__Request__exception_raise_t *In0P)
{
...
mig_internal kern_return_t __MIG_check__Request__exception_raise_state_t(__Request__exception_raise_state_t *In0P, __Request__exception_raise_state_t **In1PP)
{
...
mig_internal kern_return_t __MIG_check__Request__exception_raise_state_identity_t(__Request__exception_raise_state_identity_t *In0P, __Request__exception_raise_state_identity_t **In1PP)
{
