...
vm_mem_bootstrap(void)
{
	...
	printf( "doing vm_page_bootstrap...\n" );
	...
	zone_bootstrap();
	printf( "done zone_bootstrap\n");
	vm_object_bootstrap();
	printf( "done vm_object_bootstrap\n");
	vm_map_init();
	printf( "done vm_map_init\n");
	kmem_init(start, end);
	printf( "done kmem_init\n");
	pmap_init();
	printf( "done pmap_init\n");
