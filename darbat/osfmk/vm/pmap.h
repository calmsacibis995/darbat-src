 ...
 */
// TGB HACK TO INSERT COMMPAGE STUFF
void pmap_commpage_hack(pmap_t pmap);
...
// TGB Addition for using pmap to resolve faults
extern ppnum_t pmap_fault(pmap_t pmap, addr64_t va, vm_prot_t prot);
