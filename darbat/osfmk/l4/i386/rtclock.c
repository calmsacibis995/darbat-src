...
rtc_lapic_timer_calibrate(void)
{
	...
	/* Shut up, gcc */
	(void) rtc_lapic_timer_calibrate;
...
/* This needs to be called on clock interrupts to push the 
 * 
 */
// static 

/* so we can call from darbat clock handler */
...
#else
	// printf( "XXX: skipping pre-emption checks in rtc_nanotime_update\n" );
#endif   
