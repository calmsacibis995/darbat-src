 ...
 * XXX DARBAT
 *
 * This conflicts with Chuck's DBG() macro.
 * Below the #undef, you cannot use Chuck's macro.
 */
#undef DBG
...
//static void	mp_rendezvous_action(void); // TGB HACK
