...
/* FIXME: to go in a header file */
__private_extern__ unsigned short ul_cksum(void *, int);
__private_extern__ boolean_t ufs_label_check(struct ufslabel *);
__private_extern__ void ufs_label_init(struct ufslabel *);
...
#ifdef DEBUG
		printf("ufslabel_check: label has incorect version %ld "
