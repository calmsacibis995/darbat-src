...
/* FIXME: this is seedy */
#include <stddef.h>
// #include <time.h>  /* if we don't define this time thingy... */
...
// Iguana already defines size_t which is what __darwin_size_t is used
// for. So we just define that size_t is defined. CEG.
...
// We can use the gcc ones, thanks. CEG.
// #ifdef KERNEL
...
// #define	_CLOCK_T
// typedef clock_t		__darwin_clock_t;	/* clock() */
...
// #define	_TIME_T
// typedef time_t			__darwin_time_t;	/* time() */
