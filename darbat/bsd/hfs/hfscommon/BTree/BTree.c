...
/*
	...
	Change History (most recent first):
	  <DARBAT>	 10/27/05	ceg		Fix warnings
...
// XXXdbg
// XXX: is this even used? CEG
__private_extern__ OSStatus BTIsDirty(FCB *filePtr);

/* XXX: header */
__private_extern__ OSStatus TreeIsDirty(BTreeControlBlockPtr btreePtr);
								 ...
								 UInt32					lastsync)
{
	...
	M_ReturnErrorIf (btreePtr == nil,	fsBTInvalidFileErr);
	M_ReturnErrorIf (((void*)lastsync) == nil,	paramErr);
