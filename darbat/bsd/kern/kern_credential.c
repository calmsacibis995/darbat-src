...
#include <igcompat/compat.h> /* b.* */
#include <sys/kauth.h>       /* kauth_guid_equal */
...
/* FIXME: this isn't used unless we have AUDIT on. CEG */
kauth_cred_t kauth_cred_setauditinfo(kauth_cred_t cred, auditinfo_t *auditinfo_p);
