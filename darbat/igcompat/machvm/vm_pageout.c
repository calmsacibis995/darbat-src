	...
	int pages)
{
	...
	printf( "****** vm_page_free_reserve\n" );
	printf( "vm_page_free_reserved(1): %d\n", vm_page_free_reserved );
	...
	printf( "pages: %d\n", pages );
	printf( "vm_page_free_reserved(2): %d\n", vm_page_free_reserved );
	printf( "vm_page_free_count_init: %d\n", vm_page_free_count_init );
	printf( "free_after_reserve: %d\n", free_after_reserve );
	printf( "VMPFT: %d\n", VM_PAGE_FREE_TARGET(free_after_reserve) );

	vm_page_free_target = vm_page_free_reserved +
		VM_PAGE_FREE_TARGET(free_after_reserve);

	printf( "vm_page_free_target: %d\n", vm_page_free_target );
...
vm_pageout_continue(void)
{
	...
	printf( "MARK: vm_pageout_continue about to thread_block\n" );
